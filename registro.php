...
<head>
    ...
    <style>
        ...
        .header-text h1 { margin: 0; color: #2c3e50; font-size: 1.8em; }
        ...
        .info-nota { display: block; font-size: 0.8em; color: #95a5a6; margin-top: 6px; line-height: 1.4; }
        ...
        .seccion-seguridad h3 { margin: 0 0 15px 0; font-size: 1em; color: #e67e22; display: flex; align-items: center; gap: 8px; }
        ...
        .btn-ingresar:hover { background: #219150; transform: translateY(-2px); box-shadow: 0 6px 12px rgba(39, 174, 96, 0.3); }
    ...
    <div class="login-card">
        ...
        <form action="procesar_registro.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="tel" id="telefono" name="telefono" required placeholder="Ej: 04141234567" pattern="[0-9]+" title="Ingresa solo números, sin guiones ni espacios">
                <span class="info-nota">🔒 Usaremos este número internamente para comunicarnos contigo y verificar tu identidad como testigo de Jehová.</span>
            </div>

            <div class="seccion-seguridad">
                <h3>🛡️ Preguntas de Seguridad</h3>
                <span class="info-nota" style="margin-bottom: 15px; display: block;">Requeridas en caso de que olvides tu contraseña en el futuro.</span>
