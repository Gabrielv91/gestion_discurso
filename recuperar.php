...
<head>
    ...
    <style>
        ...
        .login-card { 
            ...
            padding: 40px 35px; 
            border-top: 6px solid #e67e22; /* Color Naranja para "Alerta/Recuperación" */
        }

        .header-text { text-align: center; margin-bottom: 30px; }
        .header-text h1 { margin: 0; color: #2c3e50; font-size: 1.5em; }
        .header-text p { color: #7f8c8d; margin-top: 8px; font-size: 0.95em; line-height: 1.4; }
        ...
        .btn-ingresar:hover { background: #d35400; transform: translateY(-2px); box-shadow: 0 6px 12px rgba(230, 126, 34, 0.3); }
        ...
        .btn-admin:hover { background: #1ebe57; transform: translateY(-2px); }
        ...
        .info-nota { font-size: 0.8em; color: #7f8c8d; margin-top: 5px; display: block; }
    </style>
</head>
<body>
    ...
    <main class="login-container">
        <div class="login-card">
            ...
            <form action="procesar_recuperacion.php" method="POST">
                ...
                <div class="form-group" style="margin-top: 25px; background: #f8f9fa; padding: 15px; border-radius: 8px; border-left: 4px solid #3498db;">
                    <label for="nueva_password" style="color: #2980b9;">🔑 Crea una nueva contraseña:</label>
                    <input type="password" id="nueva_password" name="nueva_password" required placeholder="Ingresa tu nueva contraseña">
                    <span class="info-nota">Si las respuestas de arriba son correctas, esta será tu nueva clave de acceso.</span>
                </div>
            ...
            <div style="text-align: center;">
                <p style="font-size: 0.85em; color: #7f8c8d; margin-bottom: 10px;">¿No recuerdas las respuestas o tu cuenta fue bloqueada?</p>
